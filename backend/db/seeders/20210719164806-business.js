    ...
    /*
      ...
      */
      return queryInterface.bulkInsert('Businesses', [  
        {ownerId:1,title:"Bj's",image:"https://cloudfront.bjsrestaurants.com/img_5e4c2876037db2.00079846_517_Brentwood_2019.jpg",description:"Restaurant",address:"683 Hamilton ct.",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:2,title:"In & In",image:"http://cdn.cnn.com/cnnnext/dam/assets/190710135245-12-waterfront-restaurants.jpg",description:"Restaurant",address:"1537 Park Street",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:3,title:"favourit buffet",image:"https://www.contracostalive.com/blog/wp-content/uploads/2020/08/attra1.jpg",description:"Restaurant",address:"2054 Park Street",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:4,title:"Marc",image:"https://www.elitetraveler.com/wp-content/uploads/2007/02/Alain-Ducasse-scaled.jpg",description:"Restaurant",address:"1258 Nelm Street",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:5,title:"out & out",image:"https://www.discoverlosangeles.com/sites/default/files/images/2019-01/laxbw-prime-1715-hor-wide.jpg?width=1600&height=1200&fit=crop&quality=78&auto=webp",description:"Restaurant",address:"1505 Alexander Avenue",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:6,title:"food max",image:"https://image.cnbcfm.com/api/v1/image/105365450-1533059996128arnaudsmaindiningroom_overhead.jpg?v=1533060091&w=1600&h=900",description:"Restaurant",address:"2700 EAST LELAND ROAD",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:7,title:"winco",image:"https://www.myrtlebeach.com/wp-content/uploads/2014/01/GregNormanAustralianGrille-exterior-960x480.jpg",description:"Restaurant",address:"200 Griffith Ln.",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:8,title:"Hardiz",image:"https://bloximages.chicago2.vip.townnews.com/madison.com/content/tncms/assets/v3/editorial/a/ad/aad3a0a0-5a91-5fce-9524-27cf6f819144/5e729e5c6b4f2.image.jpg?resize=1200%2C800",description:"Restaurant",address:"855 Minnesota Ave",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:1,title:"Falafl",image:"https://imagesvc.meredithcorp.io/v3/jumpstartpure/image?url=https://cf-images.us-east-1.prod.boltdns.net/v1/static/3281700261001/0f2d2cb0-b3bf-4b1b-a9bc-2c42fa9df42f/5f30bc92-252f-4c55-a98f-ef9b804f659a/1280x720/match/image.jpg&w=1280&h=720&q=90&c=cc",description:"Restaurant",address:"140 Birch St.	",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:2,title:"yalla",image:"https://img.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/6SYV7MQRYAI6ZOWKQ2YUJ7EKFU.jpg&w=1800",description:"Restaurant",address:"6651 Lone Tree Way",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:3,title:"Harbor",image:"https://assets.bwbx.io/images/users/iqjWHBFdfxIU/iS9YdetcwkPo/v0/1000x-1.jpg",description:"Restaurant",address:"850 Second St.",city:"Brentwood",state:"CA",zipCode:94513,createdAt:new Date(),updatedAt: new Date()},
        ...
        {ownerId:2,title:'PARTO',image:'https://static.onecms.io/wp-content/uploads/sites/9/2020/04/24/ppp-why-wont-anyone-rescue-restaurants-FT-BLOG0420.jpg',description:'Restaurant',address:'999 Brentwood',city:'Brentwood',state:'CA',zipCode:94599,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:3,title:"let's eat",image:'https://cdn.vox-cdn.com/thumbor/EgF_BhrdlBxoGvra6xnkxDlcdkg=/0x0:2250x1500/1200x900/filters:focal(945x570:1305x930)/cdn.vox-cdn.com/uploads/chorus_image/image/57022519/The_Rockaway_Hotel_Margie_s__Kyle_Knodell__3_.257.jpg',description:'Restaurant',address:'999 WC',city:'Brentwood',state:'CA',zipCode:94599,createdAt:new Date(),updatedAt: new Date()},
        {ownerId:4,title:"yummy",image:'https://www.discoverlosangeles.com/sites/default/files/images/2019-01/laxbw-prime-1715-hor-wide.jpg?width=1600&height=1200&fit=crop&quality=78&auto=webp',description:'Restaurant',address:'Brentwood Plaza',city:'Brentwood',state:'CA',zipCode:94599,createdAt:new Date(),updatedAt: new Date()},
